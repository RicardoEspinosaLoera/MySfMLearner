...
def get_ilumination_invariant_features(img):
    ...
    M1 = F.conv2d(img_gray, K1_, padding=0, stride=[12,1,1,1])
    M2 = F.conv2d(img_gray, K2_, padding=0, stride=[12,1,1,1])
    M3 = F.conv2d(img_gray, K3_, padding=0, stride=[12,1,1,1])
    M4 = F.conv2d(img_gray, K4_, padding=0, stride=[12,1,1,1])
    M5 = F.conv2d(img_gray, K5_, padding=0, stride=[12,1,1,1])
    M6 = F.conv2d(img_gray, K6_, padding=0, stride=[12,1,1,1])
    M7 = F.conv2d(img_gray, K7_, padding=0, stride=[12,1,1,1])
    M8 = F.conv2d(img_gray, K8_, padding=0, stride=[12,1,1,1])
