            ...
            for f_i in self.opt.frame_ids[1:]:
                if f_i != "s":
                    ...
                    for scale in self.opt.scales:
                        ...
                        outputs["b_"+str(scale)+"_"+str(f_i)].reshape(outputs["b_"+str(scale)+"_"+str(f_i)].shape[0],1,outputs["b_"+str(scale)+"_"+str(f_i)].shape[2],outputs["b_"+str(scale)+"_"+str(f_i)].shape[3])
                        outputs["c_"+str(scale)+"_"+str(f_i)] = outputs_lighting[("lighting", scale)][:,1,:,:] 
                        outputs["c_"+str(scale)+"_"+str(f_i)].reshape(outputs["c_"+str(scale)+"_"+str(f_i)].shape[0],1,outputs["c_"+str(scale)+"_"+str(f_i)].shape[2],outputs["c_"+str(scale)+"_"+str(f_i)].shape[3])
